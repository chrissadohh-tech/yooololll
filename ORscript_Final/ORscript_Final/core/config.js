...
const RS = (() => {
  ...
  function toolCategory(name) {
    ...
    if (/^(multi_edit|insert_from_creator_store|store_image)$/.test(n) || n === "execute_luau")
      return "edit";
    if (n === "screen_capture" || n === "or_screenshot" || n === "screenshot" || n === "take_screenshot" || n === "send_screenshot" || n === "attach_feedback" || n === "attachfeedbackor" || n === "attach_image" || n === "attach_screenshot" || n === "attach_file" || n === "attach_last_screenshot" || n === "copy_screenshot" || n === "paste_screenshot" ) return "screen";

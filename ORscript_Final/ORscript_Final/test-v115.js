...
ok("or_screenshot send-to-self", mainSrc.includes('name === "or_screenshot"') && mainSrc.includes('type: "capture_tab"') && !mainSrc.includes('take_screenshot: "or_screenshot"') && mainSrc.includes("A.pendingImages = shots") && bg.includes('case "capture_tab"') && cfgSrc.includes("or_screenshot") && manJs.includes("1.18.0"));
